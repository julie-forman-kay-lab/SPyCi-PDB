...
![Plots of distributions of back-calculated experimental data of 100 structures of drkN SH3 generated using IDPConformerGenerator [@Teixeira2022]. Panel (A) shows back-calculated J-couplings in Hz based on the Karplus equation with A, B, and C constants derived from Lincoff et al. [@Lincoff2020]. Not every residue has a J-coupling associated as per the provided experimental file template. Panel (B) shows back-calculated Rh values in Angstroms using HullRad [@Fleming2018].\label{fig}](fig1.png)
